...
const QuizCatalog = () => {
    ...
    return <div className="h-screen w-screen">
        <div className="relative h-2/5 w-full bg-slate-300">
            ...
            />
            <div className={`absolute top-2/7 left-3/7 text-3xl font-semibold ${styles['speech-bubble']}`}>
                <span></span>
                Witaj w stajni Umamusume!
                <br/>
                Sprawdź swoją wiedzę w jednym z poniższych quizów.
            </div>
        </div>
